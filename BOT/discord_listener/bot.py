...
@bot.command(name='baby', help='	The Baby')
async def baby(ctx):
	message =  ctx.message.content
	print("send a new mesage to rabbitmq: "+message)
	channelMQ.basic_publish(exchange='cartero', routing_key="links", body=message)
	
@bot.command(name='aproach', help='	Aproach')
async def baby(ctx):
	message =  ctx.message.content
	print("send a new mesage to rabbitmq: "+message)
	channelMQ.basic_publish(exchange='cartero', routing_key="links", body=message)
	
@bot.command(name='metroids', help='	Metroids')
async def baby(ctx):
	message =  ctx.message.content
	print("send a new mesage to rabbitmq: "+message)
	channelMQ.basic_publish(exchange='cartero', routing_key="links", body=message)

@bot.command(name='like', help='	Samus Like')
async def baby(ctx):
	message =  ctx.message.content
	print("send a new mesage to rabbitmq: "+message)
	channelMQ.basic_publish(exchange='cartero', routing_key="links", body=message)

@bot.command(name='guayando', help='	Dark Samus Guayando')
async def baby(ctx):
	message =  ctx.message.content
	print("send a new mesage to rabbitmq: "+message)
	channelMQ.basic_publish(exchange='cartero', routing_key="links", body=message)

@bot.command(name='fornite', help='	Samus Fornite')
async def baby(ctx):
	message =  ctx.message.content
	print("send a new mesage to rabbitmq: "+message)
	channelMQ.basic_publish(exchange='cartero', routing_key="links", body=message)

@bot.command(name='ridley', help='	Ridley Beam')
async def baby(ctx):
	message =  ctx.message.content
	print("send a new mesage to rabbitmq: "+message)
	channelMQ.basic_publish(exchange='cartero', routing_key="links", body=message)

@bot.command(name='cannon', help='	Samus Cannon')
async def baby(ctx):
	message =  ctx.message.content
	print("send a new mesage to rabbitmq: "+message)
	channelMQ.basic_publish(exchange='cartero', routing_key="links", body=message)
